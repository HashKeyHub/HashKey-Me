...
use hashkeyme_runtime::{self, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	hashkeyme_runtime::api::dispatch,
	hashkeyme_runtime::native_version,
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = sc_service::ServiceBuilder::new_full::<
			hashkeyme_runtime::opaque::Block, hashkeyme_runtime::RuntimeApi, crate::service::Executor
		>($config)?
